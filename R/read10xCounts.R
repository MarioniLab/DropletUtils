...
#' 
#' Alternatively, strings may contain a path to a HDF5 file in the sparse matrix format generated by 10X.
...
read10xCounts <- function(samples, sample.names=names(samples), col.names=FALSE, type=c("auto", "sparse", "HDF5"), 
