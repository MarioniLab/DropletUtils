...
We recommend making some diagnostic plots such as the total count against the deviance.
Droplets detected as cells should show up with large deviances _or_ very large total counts (based on the knee point reported by `barcodeRanks`).
